    ...
    return (
        <svg width="28" height="26" viewBox="0 0 28 26" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
                fill-rule="evenodd"
                clip-rule="evenodd"
                d="M1.82915 12.4644C0.398487 7.99776 2.07049 2.89243 6.75982 1.38176C9.22649 0.585762 11.9492 1.0551 13.9998 2.59776C15.9398 1.09776 18.7625 0.591096 21.2265 1.38176C25.9158 2.89243 27.5985 7.99776 26.1692 12.4644C23.9425 19.5444 13.9998 24.9978 13.9998 24.9978C13.9998 24.9978 4.13049 19.6271 1.82915 12.4644Z"
                stroke="#999999"
                stroke-width="1.5"
                stroke-linecap="round"
                stroke-linejoin="round"
