...
const CaloriesColumnSearchingBreakfast: React.FC<CaloriesResultProps> = observer(({ closeSearch, meal }) => {
    ...
    let dialogSearchingColumnData = usePagination(caloriesStore.breakfastCategory, caloriesStore.perPage);
...
export default CaloriesColumnSearchingBreakfast;
